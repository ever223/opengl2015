...
GLTriangleBatch		sunBatch;               //太阳
GLBatch				floorBatch;
GLTriangleBatch     earthBatch;             //地球
GLFrame             cameraFrame;
GLTriangleBatch     moonBatch;              //月亮
...
void SetupRC()
{
    ...
    // This makes a sun
    gltMakeSphere(sunBatch, 0.2f, 26, 13);
...
void RenderScene(void)
{
    ...
    modelViewMatrix.Rotate(earthAngle, 0.0f, 1.0f, 0.0f);
    modelViewMatrix.PushMatrix();
    ...
    modelViewMatrix.Rotate(earthAngle/30.0 * 360.0 - earthAngle/360.0 * 360.0, 0.0f, 0.0f, 1.0f);
    modelViewMatrix.Translate(0.8f, 0.0f, 0.0f);
    shaderManager.UseStockShader(GLT_SHADER_POINT_LIGHT_DIFF, transformPipeline.GetModelViewMatrix(),
